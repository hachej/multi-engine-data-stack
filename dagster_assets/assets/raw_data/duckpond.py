# source : https://github.com/petehunt/dagster-poor-mans-data-lake/blob/main/jaffle/duckpond.py
...
class DuckPondIOManager(IOManager):
    ...
    def _get_s3_url(self, context):
        ...
        return f"s3://{self.bucket_name}/{self.prefix}{'/'.join(id)}/{timestamp_str}.parquet"
